...
project = u'Algorithms Fourth Edition'
...
html_logo = "_static/img/algologo.png"
html_theme_options = {
    'logo_only': True
}
...
latex_documents = [
  ('index', 'algorithms.tex', u'Algorithms Fourth Edition Documentation',
   u'Todd Young', 'manual'),
]
...
man_pages = [
    ('index', 'algorithms', u'Algorithms Fourth Edition Documentation',
     [u'Todd Young'], 1)
]
...
texinfo_documents = [
  ('index', 'algorithms', u'Algorithms Fourth Edition Documentation',
   u'Todd Young', 'algorithms', 'One line description of project.',
   'Miscellaneous'),
]
